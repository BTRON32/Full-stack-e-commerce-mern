    ...
    {/*-------------------- Product Data---------------------- */}
      ...
      {/* ----------------------Product Info----------------- */}
          <div className="flex-1 ">
            ...
            <button onClick={()=>addToCart(productData._id,size, toast.success("Product Added to Cart"))} className='bg-black text-white px-8 py-3 text-sm active:bg-gray-700'>ADD TO CART</button>
